...
let IconMoban: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconMoban.defaultProps = {
  size: 18,
};

IconMoban = React.memo ? React.memo(IconMoban) : IconMoban;

export default IconMoban;
